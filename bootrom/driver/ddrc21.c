...
//register unsigned long *debug_val asm("t2")= 0;
    ...
    writel(0x001300d0, 0x00010104);//writel(0x001300d0, 0x00020027);
    writel(0x001300d4, 0x0003000a);//writel(0x001300d4, 0x00270006);
    writel(0x001300dc, 0x06240001);//writel(0x001300dc, 0x0a310001);
    writel(0x001300e0, 0x00100200);//writel(0x001300e0, 0x10180200);
    writel(0x001300e4, 0x00110000);//writel(0x001300e4, 0x00110000);
    writel(0x001300e8, 0x00001840);//writel(0x001300e8, 0x00000640);
    writel(0x001300ec, 0x00000800);//writel(0x001300ec, 0x00000800);
    writel(0x001300f0, 0x00000010);
    writel(0x00130100, 0x100c2412);//writel(0x00130100, 0x110d2914);
    writel(0x00130104, 0x00040519 );//writel(0x00130104, 0x0004051b);
    writel(0x00130108, 0x0607050c);//writel(0x00130108, 0x06080510);
    writel(0x0013010c, 0x0000400c);//writel(0x0013010c, 0x0000f00f);
    writel(0x00130110, 0x07030307);//writel(0x00130110, 0x08030309);
    writel(0x00130114, 0x0f0f0403);//writel(0x00130114, 0x0f0e0404);
    writel(0x00130120, 0x0707640d);//writel(0x00130120, 0x06060e08);
    writel(0x00130124, 0x00020209);//writel(0x00130124, 0x0002020d);
    writel(0x00130128, 0x000e0d0a);//writel(0x00130128, 0x000f0e05);
    writel(0x0013012c, 0x1708010e);//writel(0x0013012c, 0x14090112);
    writel(0x00130130, 0x0c00000b);//writel(0x00130130, 0x0c00000d);
    writel(0x0013013c, 0x80000000);
    ...
    writel(CPU_PLL_CTL1_BASE + 0x0, 0x130c8);//pll1foutpostdiv=(24*200/3/3/1)=533.3MHz
    writel(CPU_PLL_CTL1_BASE + 0x4, 0x0    );
    writel(CPU_PLL_CTL1_BASE + 0x8, 0x300  );
